...
Python 标准库实现的本地基金监控 Web 应用，无需外部框架依赖。
...
├── email_template.html     # 晚报邮件模板
└── deploy/                 # 部署配置
    ├── fund-monitor.service/.timer
    ├── fund-watch.service/.timer
    ├── global-briefing.service/.timer
    └── install.sh
```
