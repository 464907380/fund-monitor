  ...
  fetch(API + '/api/holdings?code=' + code)
    ...
    .then(function(d){
      ...
      d.holdings.forEach(function(h){
        ...
        tbl += '<tr><td style="padding:3px 6px;border-bottom:1px solid #333;color:#e0e0e0;max-width:120px;overflow:hidden;text-overflow:ellipsis;position:sticky;left:0;z-index:1;background:#1a1a1a;"><span style="cursor:default;color:' + freshnessColor + ';font-size:10px;" title="' + freshnessTitle + '">●</span> <span onclick="event.stopPropagation();showStockInfo(\'' + htmlEscape(h.n || '') + '\',\'' + stockFullCode + '\')" style="cursor:pointer;border-bottom:1px dashed rgba(255,255,255,0.25);" title="财报:' + (h.fgl_date || '无') + '\nK线:最新交易日\n行情:今日实时\n上市：' + (h.listing_date || '-') + '\n行业：' + (h.industry || '-') + '\n点击查看详情">' + htmlEscape(h.n || '') + '</span></td>'
