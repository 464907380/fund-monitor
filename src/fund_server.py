    ...
    def do_GET(self):
        ...
        if parsed.path == "/api/holdings-dims":
            ...
            try:
                ...
                # 返回默认
                default_dims = [
                    {"key":"roe","name":"ROE","w":10,"curve":[[0,0],[5,20],[10,40],[15,60],[20,80],[30,100]]},
                    {"key":"main_biz_margin","name":"主营利润率","w":8,"curve":[[0,0],[10,10],[20,30],[40,60],[60,80],[80,100]]},
                    {"key":"net_profit_margin","name":"销售净利率","w":6,"curve":[[0,0],[3,15],[8,40],[15,65],[25,85],[40,100]]},
                    {"key":"debt_ratio","name":"资产负债率","w":10,"curve":[[0,90],[20,85],[40,70],[60,50],[80,20],[95,0]]},
                    {"key":"rev_growth","name":"营收增长","w":6,"curve":[[-20,0],[0,30],[10,50],[30,75],[60,90],[100,100]]},
                    {"key":"quick_ratio","name":"速动比率","w":6,"curve":[[0,0],[0.3,20],[0.6,40],[1,65],[1.5,85],[3,100]]},
                    {"key":"cf_ps","name":"每股现金流","w":3,"curve":[[-2,0],[0,25],[0.5,50],[1,70],[3,90],[5,100]]},
                    {"key":"mdd_1y","name":"1年回撤","w":8,"curve":[[0,100],[10,85],[20,65],[30,40],[50,15],[70,0]]},
                    ...
                    {"key":"pe","name":"PE","w":4,"curve":[[0,90],[10,70],[20,50],[40,30],[60,15],[80,5]]},
                    ...
                    {"key":"gross_margin","name":"销售毛利率","w":6,"curve":[[0,0],[10,10],[20,30],[40,60],[60,80],[80,100]]},
