                        ...
                        for _f in fund_list:
                            ...
                            if _cr:
                                ...
                                _ft_rows.append({
                                    ...
                                    "_day": _cr.get("day","") or "",
                                    "_f5": _cr.get("f5") if _cr.get("f5") is not None else "",
                                    "_m1": f"{_cr['m1']:+.1f}%" if isinstance(_cr.get("m1"), (int, float)) else (_cr.get("m1") or ""),
                                    "_m3": f"{_cr['m3']:+.1f}%" if isinstance(_cr.get("m3"), (int, float)) else (_cr.get("m3") or ""),
                                    "_y1": f"{_cr['y1']:+.1f}%" if isinstance(_cr.get("y1"), (int, float)) else (_cr.get("y1") or ""),
